...
void patch_payload(unsigned char *payload, size_t payload_size, uint64_t text_vaddr, uint64_t text_size, uint64_t orig_entry) {
    printf("[patch_payload] text_vaddr=0x%lx text_size=0x%lx orig_entry=0x%lx\n", text_vaddr, text_size, orig_entry);
